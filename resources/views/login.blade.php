...
<body class="w-screen h-screen bg-verde-azulado">
    <div class="content mx-auto flex flex-col pt-8 md:pt-32 w-4/5 md:w-2/3">
        <img src="{{asset('logoBlanco.png')}}" class="w-full md:w-2/5 mx-auto" alt="logo">
        <form class="w-full md:w-3/5 mx-auto">
            @csrf
            <fieldset class="mb-5">
                ...
                <div class="flex flex-col md:flex-row space-y-3 md:space-y-0 md:space-x-8">
                    <div class="has-[:focus]:outline-2 has-[:focus]:outline-dotted">
                        <label for="becario"><input type="radio" id="becario" tabindex="0" name="rol"
                            class="bg-gray-50" maxlength="30" checked required/><span class="ml-2 text-white">Becario</span></label>
                    </div>
                    <div class="has-[:focus]:outline-2 has-[:focus]:outline-dotted">
                        
                        <label for="admin"><input type="radio" id="admin" tabindex="0" name="rol"
                            class="bg-gray-50 border-2" maxlength="30"/><span class="ml-2 text-white">Administrador</span></label>
                    </div>
                </div>
            </fieldset>
            <div class="mb-5">
                <label for="usuario" class="block mb-2 text-lg font-medium text-white ">Usuario:</label>
                <input type="text" id="usuario" tabindex="0"
            ...
            <div class="mb-5 flex justify-center">
                <button type="submit" tabindex="0"
                    class="text-white bg-coral hover:bg-coral-oscuro focus:ring-4 focus:outline-none focus:ring-blue-900 font-medium rounded-lg text-md w-5/6 sm:w-auto px-5 py-2.5 text-center">
