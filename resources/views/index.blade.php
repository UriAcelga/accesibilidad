...
<body class="w-screen h-screen bg-verde-azulado print:text-sm print:bg-white print:text-black">
    ...
    <div class="w-5/6 lg:w-4/5 mx-auto flex pt-8 md:pt-12 print:m-0 font-roboto ">
        {{-- Filtros de busqueda --}}
        <form method="GET" class="p-4 w-full border-2 rounded-lg border-azul-marino flex space-x-4">
            <div>
            ...
            <div class="w-1/3">
                <x-dropdown-badges :facultades="$facultades" prompt="Filtrar por Facultad" field_name="filter[facultad.codigo]"
                    label="Facultad"></x-dropdown-badges>
            </div>
            <div class="w-1/3">
    ...
    <div role="region" aria-labelledby="Cap1" tabindex="0"
        ...
        <table id="registros">
            ...
            <tr class="hidden md:table-row print:border-b-2">
                ...
                <th class="{{ $estilosThTexto }}">Ficha Académica</th>
            </tr>
        ...
        <span class="w-full bg-azul-marino text-center text-white text-lg {{ $estudiantes->isEmpty() ? '' : 'hidden' }}">No hay estudiantes
